...
const plansPT: PlanGH[] = [
  ...
  { id: 'gh_essencial', name: 'Essencial GH', price: 'R$ 16,90', duration: 'Protocolo Completo', gainEstimate: 'Até 7cm', features: ['O plano mais popular e recomendado.', 'Técnicas avançadas de alongamento e fortalecimento postural.', 'Guia de otimização de rotina e hábitos.', 'Suporte prioritário e acesso à comunidade premium.'], purchaseLink: 'https://pay.kiwify.com.br/l05kkMT', purchaseLinkCommunity: '', highlight: 'RECOMENDADO', borderColor: 'border-[#FF0000]', buttonColor: 'bg-[#FF0000] hover:bg-[#FF3333]', badgeColor: 'bg-[#FF0000]' },
  { id: 'gh_elite', name: 'Elite GH', price: 'R$ 19,90', duration: 'Protocolo Intensivo VIP', gainEstimate: 'Até 12cm', features: ['Resultados máximos no menor tempo possível.', 'Acompanhamento individualizado com especialista GH.', 'Plano de exercícios e nutrição 100% personalizados.', 'Acesso VIP vitalício à comunidade e todos os bônus.'], purchaseLink: 'https://pay.kiwify.com.br/Ooz2222', purchaseLinkCommunity: 'https://pay.kiwify.com.br/FtguSCG', highlight: 'PREMIUM', borderColor: 'border-purple-500', buttonColor: 'bg-purple-600 hover:bg-purple-700', badgeColor: 'bg-purple-600' },
];

const plansEN: PlanGH[] = [
    { id: 'gh_simple', name: 'Simple GH', price: '$10', duration: 'Fundamental Protocol', gainEstimate: 'Up to 3cm', features: ['Introduction to the GH Method.', 'Basic decompression and alignment exercises.', 'Ideal for initial gains and slight posture improvement.', 'Access to the member community.'], purchaseLink: 'https://pay.kiwify.com/FNBiayZ', purchaseLinkCommunity: 'https://pay.kiwify.com/1FOJzC2', highlight: 'BEGINNER', borderColor: 'border-gray-700', buttonColor: 'bg-gray-700 hover:bg-gray-600', badgeColor: 'bg-blue-600' },
    { id: 'gh_essencial', name: 'Essential GH', price: '$14', duration: 'Complete Protocol', gainEstimate: 'Up to 7cm', features: ['The most popular and recommended plan.', 'Advanced stretching and postural strengthening techniques.', 'Routine and habit optimization guide.', 'Priority support and access to the premium community.'], purchaseLink: 'https://pay.kiwify.com/tRG0tJO', purchaseLinkCommunity: 'https://pay.kiwify.com/CjpjZOl', highlight: 'RECOMMENDED', borderColor: 'border-[#FF0000]', buttonColor: 'bg-[#FF0000] hover:bg-[#FF3333]', badgeColor: 'bg-[#FF0000]' },
    { id: 'gh_elite', name: 'Elite GH', price: '$20', duration: 'Intensive VIP Protocol', gainEstimate: 'Up to 12cm', features: ['Maximum results in the shortest possible time.', 'Individualized monitoring with a GH specialist.', '100% personalized exercise and nutrition plan.', 'Lifetime VIP access to the community and all bonuses.'], purchaseLink: 'https://pay.kiwify.com/8GN3oXh', purchaseLinkCommunity: 'https://pay.kiwify.com/BN2QPt1', highlight: 'PREMIUM', borderColor: 'border-purple-500', buttonColor: 'bg-purple-600 hover:bg-purple-700', badgeColor: 'bg-purple-600' },
];

const plansES: PlanGH[] = [
    { id: 'gh_simple', name: 'Simple GH', price: '€10', duration: 'Protocolo Fundamental', gainEstimate: 'Hasta 3cm', features: ['Introducción al Método GH.', 'Ejercicios básicos de descompresión y alineación.', 'Ideal para ganancias iniciales y mejora postural leve.', 'Acceso a la comunidad de miembros.'], purchaseLink: 'https://pay.kiwify.com/4i9SNZY', purchaseLinkCommunity: 'https://pay.kiwify.com/1II1Mz5', highlight: 'PRINCIPIANTE', borderColor: 'border-gray-700', buttonColor: 'bg-gray-700 hover:bg-gray-600', badgeColor: 'bg-blue-600' },
    { id: 'gh_essencial', name: 'Esencial GH', price: '€14', duration: 'Protocolo Completo', gainEstimate: 'Hasta 7cm', features: ['El plan más popular y recomendado.', 'Técnicas avanzadas de estiramiento y fortalecimiento postural.', 'Guía de optimización de rutina y hábitos.', 'Soporte prioritario y acceso a la comunidad premium.'], purchaseLink: 'https://pay.kiwify.com/R0aVhGD', purchaseLinkCommunity: 'https://pay.kiwify.com/T5NiA7D', highlight: 'RECOMENDADO', borderColor: 'border-[#FF0000]', buttonColor: 'bg-[#FF0000] hover:bg-[#FF3333]', badgeColor: 'bg-[#FF0000]' },
    { id: 'gh_elite', name: 'Elite GH', price: '€20', duration: 'Protocolo Intensivo VIP', gainEstimate: 'Hasta 12cm', features: ['Resultados máximos en el menor tiempo posible.', 'Seguimiento individualizado con un especialista GH.', 'Plan de ejercicios y nutrición 100% personalizados.', 'Acceso VIP vitalicio a la comunidad y todos los bonos.'], purchaseLink: 'https://pay.kiwify.com/K6S7ptV', purchaseLinkCommunity: 'https://pay.kiwify.com/jfx1B8K', highlight: 'PREMIUM', borderColor: 'border-purple-500', buttonColor: 'bg-purple-600 hover:bg-purple-700', badgeColor: 'bg-purple-600' },
];
...
export const translations = {
  ...
  en: {
    ...
    plans: plansEN,
    upsellModal: { title: "Excellent Choice!", subtitle: (planName) => `Boost Your <span class="text-white">${planName.split(' ')[1]}</span> Journey`, description: "Join the GH Community and accelerate your results with exclusive support and premium content.", totalLabel: "Total", communityLabel: "GH Community", ctaButton: "I WANT THE GH COMMUNITY", declineButton: (planName) => `Continue with my ${planName} only`, communityPriceDisplay: (price: string) => `+ $${price}`, totalPriceDisplay: (total: string) => `$${total}`},
    communityDetails: { price: "2.00", features: [{ icon: "user-circle", text: "Exclusive GH Community" }, { icon: "home", text: "Lifetime access, pay once." }, { icon: "puzzle", text: "Monthly challenges and bonus content." }, { icon: "users", text: "Group mentoring and experience sharing." }], footerPoints: ["Immediate Access", "No Monthly Fees", "Continuous Support"] },
